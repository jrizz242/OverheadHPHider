...
enum HealthbarOverride implements SpriteOverride
{
    ...
    DEFAULT_FRONT_40PX(SpriteID.StandardHealth30.FRONT, "default_front_40px.png"),
    DEFAULT_FRONT_50PX(SpriteID.StandardHealth30.FRONT, "default_front_40px.png"),
    DEFAULT_FRONT_60PX(SpriteID.StandardHealth30.FRONT, "default_front_40px.png"),
    DEFAULT_FRONT_70PX(SpriteID.StandardHealth30.FRONT, "default_front_40px.png"),
    DEFAULT_FRONT_80PX(SpriteID.StandardHealth30.FRONT, "default_front_40px.png"),
    DEFAULT_FRONT_90PX(SpriteID.StandardHealth30.FRONT, "default_front_40px.png"),
    DEFAULT_FRONT_100PX(SpriteID.StandardHealth30.FRONT, "default_front_40px.png"),
    DEFAULT_FRONT_120PX(SpriteID.StandardHealth30.FRONT, "default_front_40px.png"),
    DEFAULT_FRONT_140PX(SpriteID.StandardHealth30.FRONT, "default_front_40px.png"),
    DEFAULT_FRONT_160PX(SpriteID.StandardHealth30.FRONT, "default_front_40px.png"),

    DEFAULT_BACK_30PX(SpriteID.StandardHealth30.BACK, "default_back_40px.png"),
    DEFAULT_BACK_40PX(SpriteID.StandardHealth30.BACK, "default_back_40px.png"),
    DEFAULT_BACK_50PX(SpriteID.StandardHealth30.BACK, "default_back_40px.png"),
    DEFAULT_BACK_60PX(SpriteID.StandardHealth30.BACK, "default_back_40px.png"),
    DEFAULT_BACK_70PX(SpriteID.StandardHealth30.BACK, "default_back_40px.png"),
    DEFAULT_BACK_80PX(SpriteID.StandardHealth30.BACK, "default_back_40px.png"),
    DEFAULT_BACK_90PX(SpriteID.StandardHealth30.BACK, "default_back_40px.png"),
    DEFAULT_BACK_100PX(SpriteID.StandardHealth30.BACK, "default_back_40px.png"),
    DEFAULT_BACK_120PX(SpriteID.StandardHealth30.BACK, "default_back_40px.png"),
    DEFAULT_BACK_140PX(SpriteID.StandardHealth30.BACK, "default_back_40px.png"),
    DEFAULT_BACK_160PX(SpriteID.StandardHealth30.BACK, "default_back_40px.png"),
